...
/** SI4463硬件接口IO定义 */
#define SI4463_SDN_PORT				GPIOC								
#define SI4463_SDN_CLK				RCC_APB2Periph_GPIOC
#define SI4463_SDN_PIN				GPIO_Pin_5

#define SI4463_IRQ_PORT				GPIOC									
#define SI4463_IRQ_CLK				RCC_APB2Periph_GPIOC
#define SI4463_IRQ_PIN				GPIO_Pin_4

#define SI4463_GPIO0_PORT			GPIOB									
#define SI4463_GPIO0_CLK			RCC_APB2Periph_GPIOB
#define SI4463_GPIO0_PIN			GPIO_Pin_3

#define SI4463_GPIO1_PORT			GPIOB								
#define SI4463_GPIO1_CLK			RCC_APB2Periph_GPIOB
#define SI4463_GPIO1_PIN			GPIO_Pin_4
