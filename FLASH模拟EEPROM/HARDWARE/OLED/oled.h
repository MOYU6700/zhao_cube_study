...
//-----------------OLED端口定义----------------  					   
//#define OLED_SCLK_Clr() HAL_GPIO_WritePin(clk_GPIO_Port,clk_Pin,GPIO_PIN_RESET)
//#define OLED_SCLK_Set() HAL_GPIO_WritePin(clk_GPIO_Port,clk_Pin,GPIO_PIN_SET)

//#define OLED_SDIN_Clr() HAL_GPIO_WritePin(di_GPIO_Port,di_Pin,GPIO_PIN_RESET)
//#define OLED_SDIN_Set() HAL_GPIO_WritePin(di_GPIO_Port,di_Pin,GPIO_PIN_SET)
