...
void SI446x_Gpio_Init( void )
{
	...
	//IRQ GPIO0~GPIO3上拉输入
	GPIO_Init( SI4463_IRQ_PORT, SI4463_IRQ_PIN,GPIO_MODE_IN_PU_IT );
...
//	GPIO_Init( SI4463_GPIO2_PORT, SI4463_GPIO2_PIN,GPIO_MODE_IN_PU_NO_IT );
//	GPIO_Init( SI4463_GPIO3_PORT, SI4463_GPIO3_PIN,GPIO_MODE_IN_PU_NO_IT );
	
	GPIO_WriteLow( SI4463_SDN_PORT, SI4463_SDN_PIN );	//SDN 置低使能设备
}
